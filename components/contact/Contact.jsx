      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-stretch">
          ...
          <div className="flex flex-col space-y-8">
            ...
            <div className="flex space-x-3">
              {socialLinks.map((link, index) => (
                <a key={index} href={link.href} className="bg-white p-2 rounded-md hover:opacity-80 transition-opacity">
                  {link.icon}
                </a>
              ))}
            </div>
          ...
          <div className="bg-white p-8 sm:p-10 rounded-lg shadow-2xl">
            <h2 className="text-2xl font-semibold text-gray-900 text-center">Schedule call</h2>
